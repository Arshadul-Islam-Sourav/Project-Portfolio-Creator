        ...
        <a class="mobile-btn" href="#" title="Hide navigation">Hide navigation</a>
         ...
         <ul id="nav" class="nav">
           ...
           <li><a class="smoothscroll" href="#resume">Resume</a></li>
            ...
            <li><a class="smoothscroll" href=".">Blog</a></li>
            ...
            <div class="ten columns flex-container">
               ...
               <div class="flexslider">
                  ...
                  <ul class="slides">
                     ...
                     <li>
                        <blockquote>
                           <p>Jewel is an exceptional and motivated student who stands out in the ICT program at Cumilla University. His strong background in robotics and programming, combined with his passion for learning, make him a valuable contributor to any team or project.
                           </p>
                           <cite>Teacher</cite>
                        </blockquote>
                     </li> <!-- slide ends -->
                     ...
                     <li>
                        <blockquote>
                           <p>Working with Jewel on our robotics project was an absolute pleasure. His expertise in programming and robotics was essential to the project's success, and his dedication and hard work were an inspiration to the entire team. Jewel is a valuable asset to any team and an excellent collaborator.
                           </p>
                           <cite>Anik Chakraborty</cite>
                        </blockquote>
                     </li> <!-- slide ends -->
